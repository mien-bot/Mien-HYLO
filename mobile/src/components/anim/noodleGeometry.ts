// Shared SVG geometry for mobile noodle visuals. Mirrors desktop
// src/renderer/components/anim/noodleGeometry.ts — keep these in sync.
...
// 5 noodle strands inside the bowl — wavy lines filling the bowl
...
export const STEAM_PUFFS = [
  { cx: 26, cy: 18, rx: 1.5, ry: 2.2 },
  { cx: 32, cy: 16, rx: 1.8, ry: 2.4 },
  { cx: 38, cy: 18, rx: 1.5, ry: 2.2 },
]
